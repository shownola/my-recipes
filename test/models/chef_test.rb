...
class ChefTest < ActiveSupport::TestCase
  ...
  test "email should be accept correct format" do
    valid_emails = %w[user@example.com JACKSON@email.com M.first@yahoo.ca john+smith@co.uk.org]
  ...
  test "should reject invalid email addresses" do
    invalid_emails = %w[jackson@example jackson@example,com jackson.name@example joe@bar+foo.com]
  ...
  test "email should be case lower case before hitting db" do
